...
class MathEditFunction: public MathEdit
{
    Q_OBJECT
    
public:
    static constexpr int Type = MEFunction;
    int type() const override { return Type; }
    
    explicit MathEditFunction(Data *d, PageMathItem *parentPageMathItem, QGraphicsObject* parent);
    explicit MathEditFunction(QString text, Data *d, PageMathItem *parentPageMathItem, QGraphicsObject* parent);
    ...
    void setCursorRightOf(MathEdit* child) override;
    void setCursorLeftOf(MathEdit* child) override;
