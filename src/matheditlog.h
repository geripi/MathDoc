...
class MathEditLog: public MathEdit
{
    Q_OBJECT
    
public:
    static constexpr int Type = MELog;
    int type() const override { return Type; }
    
    explicit MathEditLog(Data *d, PageMathItem *parentPageMathItem, QGraphicsObject* parent);
    explicit MathEditLog(QString text, Data *d, PageMathItem *parentPageMathItem, QGraphicsObject* parent);
