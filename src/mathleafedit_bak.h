...
public:
    ...
    void setValue(QList<qreal> v) { m_value = v; }
    ...
    bool isDoubleString(const QString &s);
    bool isValidValue(QList<qreal> L);
...
private:
    ...
    QList<qreal> m_value; // Value or list of values that are represented by the name
